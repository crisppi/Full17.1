...
<body>
    ...
    <div class="container-fluid py-5">
        <form class="formulario" action="<?= $BASE_URL ?>process_internacao.php" id="select-internacao-form" method="POST" enctype="multipart/form-data">

            <h2 class="page-title">Relação internações</h2>
            <div class="container">
                <div class="form-group row">
                    <div class="form-group col-sm-3">
                        ...
                        <span id="texto">Hospital selecionado</span>

                        </p>
                    </div>
                    <div class="form-group col-sm-1">
                        <label class="control-label" for="internado">Internado</label>
                        <select class="form-control" id="internado" name="internado">
