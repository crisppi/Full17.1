        ...
        <table class="table table-sm table-striped table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                foreach ($patologias as $patologia) : ?>
                    <tr>
                        <td scope="row" class="col-id"><?= $patologia["id_patologia"] ?></td>
                        <td scope="row" class="nome-coluna-table"><?= $patologia["patologia_pat"] ?></td>
                        <td scope="row" class="nome-coluna-table"><?= $patologia["dias_pato"] ?></td>


                        <td class="action">
                            <a href="cad_patologia.php"><i style="color:green; margin-right:10px" class="aparecer-acoes bi bi-plus-square-fill edit-icon"></i></a>

                            <a href="<?= $BASE_URL ?>show_patologia.php?id_patologia=<?= $patologia["id_patologia"] ?>"><i style="color:orange; margin-right:10px" class="aparecer-acoes fas fa-eye check-icon"></i></a>

                            <a href="<?= $BASE_URL ?>edit_patologia.php?id_patologia=<?= $patologia["id_patologia"] ?>"><i style="color:blue" name="type" value="edite" class="aparecer-acoes far fa-edit edit-icon"></i></a>

                            <!--<a href="<?= $BASE_URL ?>process_patologia.php?id_patologia=<?= $patologia["id_patologia"] ?>"><i style="color:red" name="type" value="deletar" class="aparecer-acoes fas fa-times delete-icon"></i></a>
                -->
